...
<html lang="en">
  ...
  <head>
    ...
    <title>Shop Homepage -Catalogo</title>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link" href="#">Bienvenido <?php echo($_SESSION['user']); ?></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="listcarrito.php">Carrrito
              </a>
            </li>
      ...
      <div class="row">
        ...
        <div class="col-lg-3">
          ...
          <div class="list-group">
            <a href="#" class="list-group-item" name="Motherboard">Motherboard</a>
            ...
            <a href="#" class="list-group-item" name=Memorias>Accesorios</a>            
          </div>
        ...
        <div class="col-lg-9">
          ...
          <div class="row">     
              ...
              <?php
                ...
                {
                  echo("<form class=\"col-lg-4 col-md-6 mb-4\" method=\"POST\" action=\"addcarrito.php\"> ");              
                  echo("<div class=\"card h-100\">");                  
                  echo("<a href=\"#\"><img class=\"card-img-top\" src=\"img/catalogoimg/$reg[clave].jpg\"></a>");                    
                  echo("<input type=\"text\" name=\"txtclave\" value=\"$reg[clave]\" style=\"display: none;\">");

                  echo("<div class=\"card-body\">");
                  echo("<h4 class=\"card-title\">");
                  echo ("<a href=\"#\">$reg[nombre]</a></h4>");   
                  echo("<input type=\"text\" name=\"txtnombre\" value=\"$reg[nombre]\" style=\"display: none;\">");  

                  echo ("<h5>$ $reg[presio] MXN</h5>"); 
                  echo("<input type=\"text\" name=\"txtprecio\" value=\"$reg[presio]\" style=\"display: none;\">");        

                  echo("<p class=\"card-text\">$reg[descripcion]</p>");  

                  echo("<p> Cantidad:  <input type=\"number\" name=\"txtcantidad\" min=\"1\" max=\"20\" value=\"1\"></p>");
                  echo("<br>");
                  echo("<input type=\"Submit\" value=\"Agregar al carrito\" class=\"btn btn-danger\">
                    </div>");
